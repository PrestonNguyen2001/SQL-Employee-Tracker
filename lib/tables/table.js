...
class Tables {
  ...
  static sortEmployeesBySalaryTable() {
    return new Table({
      chars: {
        top: "═",
        "top-mid": "╤",
      ...
      colWidths: [10, 5, 15, 15, 30, 12], // Adjust column widths as necessary
    });
  }

  // Sort Employees by Last Name table
  static sortEmployeesByLastNameTable() {
    return new Table({
      chars: {
        top: "═",
        "top-mid": "╤",
      ...
      colWidths: [10, 5, 15, 15], // Adjust column widths as necessary
    });
  }
}
